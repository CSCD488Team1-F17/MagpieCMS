/* Not tested, Brad Howard @ 22:05 on 2/28/2017 */

CREATE TABLE Walks 
(
	WID INTEGER PRIMARY KEY NOT NULL AUTO_INCREMENT = 1, 
...
(
	LID INTEGER PRIMARY KEY NOT NULL AUTO_INCREMENT = 1,
	Name VARCHAR(100) NOT NULL,
	Longitude DOUBLE, 
	Latitude DOUBLE, 
...
(
	PicID INTEGER PRIMARY KEY NOT NULL AUTO_INCREMENT = 1,
	WID INTEGER, 
...
(
	DesID INTEGER PRIMARY KEY NOT NULL AUTO_INCREMENT = 1,
	WID INTEGER,
...
(
	QRCID INTEGER PRIMARY KEY NOT NULL AUTO_INCREMENT = 1,
	LID INTEGER,
	RawCode VARCHAR(625),
	FOREIGN KEY (LID) REFERENCES LandMarks(LID)
);